...
const PIERCING_INFO = {
  lobe: {
    ko: { name: "귓볼", name_en: "Lobe", healing: "4 ~ 6주", pain: 1, desc: "가장 기본적이고 통증이 가장 적은 부위입니다. 피어싱 입문자에게 강력히 추천하며, 다양한 크기와 형태의 귀걸이나 피어싱을 연출하기 좋습니다. 남녀노소 불문하고 가장 사랑받는 부위입니다.", tip: "시술 후 씻을 때 물기가 남지 않게 드라이어(찬바람)로 잘 말려주시면 덧나지 않고 예쁘게 아뭅니다." },
    en: { name: "Lobe", name_en: "Lobe", healing: "4 ~ 6 weeks", pain: 1, desc: "The most basic and least painful area. Highly recommended for beginners. Perfect for styling various sizes and shapes of earrings or piercings. Loved by people of all ages.", tip: "Blow dry with cool air after washing to keep it clean and help it heal beautifully without irritation." },
    ja: { name: "耳たぶ", name_en: "Lobe", healing: "4 〜 6週間", pain: 1, desc: "最も基本的で最も痛みの少ない部位です。ピアッシング初心者の方に強力におすすめします。様々なサイズや形のピアスを楽しめる、男女問わず最も愛される部位です。", tip: "洗顔や入浴後は冷風のドライヤーで湿気を飛ばして乾かすと、トラブルなく綺麗に安定します。" },
    ru: { name: "Мочка", name_en: "Lobe", healing: "4 ~ 6 недель", pain: 1, desc: "Самый классический прокол с минимальным уровнем боли. Идеален для новичков. Отлично подходит для ношения украшений любого размера и формы. Популярен среди всех возрастов.", tip: "После душа обязательно просушивайте прокол прохладным воздухом фена, чтобы избежать воспалений." },
    ar: { name: "شحمة الأذن", name_en: "Lobe", healing: "4 ~ 6 أسابيع", pain: 1, desc: "الموضع الأساسي والأقل ألماً على الإطلاق. يوصى به بشدة للمبتدئين في الثقب. ممتاز لتنسيق مختلف أحجام وأشكال الأقراط. محبوب من جميع الفئات والأعمار.", tip: "جفف المنطقة بهواء مجفف الشعر البارد بعد الاستحمام لمنع حدوث أي التهابات." },
    zh: { name: "耳垂", name_en: "Lobe", healing: "4 ~ 6周", pain: 1, desc: "最基础、痛感最低的部位。非常适合初次穿刺的新手。可搭配各种尺寸与形状的耳饰，是不分男女老少最受欢迎的经典部位。", tip: "洗脸或淋浴后，请用吹风机冷风档吹干，保持清爽有助于伤口完美愈合。" }
  },
  helix: {
    ko: { name: "귓바퀴", name_en: "Helix", healing: "2 ~ 3개월", pain: 2, desc: "귀 외곽 라인을 따라 연출하여 정면에서도 가장 눈에 잘 띄는 매력적인 부위입니다. 링 피어싱이나 트위스터, 큐빅 바벨 등 다채로운 주얼리 레이어드가 가능해 귀테리어의 핵심이 됩니다.", tip: "머리카락이나 옷을 입고 벗을 때 걸리기 쉬우니 시술 초기에는 특히 주의해 주셔야 합니다." },
    en: { name: "Helix", name_en: "Helix", healing: "2 ~ 3 months", pain: 2, desc: "Positioned along the outer cartilage rim, making it highly visible and attractive from the front. Perfect for layering rings, twist barbells, or studs. The core of any ear curation.", tip: "It easily catches on hair or clothes. Be extremely careful when dressing or brushing your hair in the beginning." },
    ja: { name: "ヘリックス", name_en: "Helix", healing: "2 〜 3ヶ月", pain: 2, desc: "耳の外側の軟骨のふちに沿って開けるため、正面から見ても最も目立つ魅力的な部位です。フープピアスやスパイラル、バーベルなど多彩なコーディネートが可能で、イヤーデコレーションの中心となります。", tip: "髪の毛や衣服の着脱時に引っかかりやすいため、施術初期は特に注意が必要です。" },
    ru: { name: "Хеликс", name_en: "Helix", healing: "2 ~ 3 месяца", pain: 2, desc: "Прокол по внешнему краю хряща, который отлично виден спереди. Позволяет сочетать кольца, циркуляры и лабреты, являясь основой красивого проекта ушной раковины.", tip: "Легко цепляется за волосы и одежду при переодевании. Будьте предельно аккуратны в первое время." },
    ar: { name: "غضروف الأذن الخارجي", name_en: "Helix", healing: "2 ~ 3 أشهر", pain: 2, desc: "ثقب على طول الحافة الغضروفية الخارجية للأذن، مما يجعله واضحاً وجذاباً من الأمام. مثالي لتنسيق الحلقات الدائرية واللوالب والقطع المرصعة، وهو أساس أي تنسيق للأذن.", tip: "قد يعلق بالشعر أو الملابس بسهولة أثناء ارتدائها أو خلعها، لذا يرجى الحذر الشديد في البداية." },
    zh: { name: "耳轮", name_en: "Helix", healing: "2 ~ 3个月", pain: 2, desc: "沿着耳廓外侧轮廓穿刺，正面视觉效果极佳。可搭配环形、扭转形或各类闪亮耳钉，是耳饰组合搭配（耳饰墙）的核心亮点部位。", tip: "极易被头发、衣服穿脱或梳头时挂蹭，穿刺初期需要格外小心防护。" }
  },
  industrial: {
  ...
  conch: {
    ko: { name: "이너컨츠", name_en: "Inner Conch", healing: "2 ~ 3개월", pain: 3, desc: "귀 안쪽의 넓은 연골 부위로, 정면에서 보았을 때 입체감 있게 반짝여서 인기가 매우 높습니다. 붓기가 가라앉은 후 큰 링이나 볼륨감 있는 주얼리로 교체하면 한층 더 화려한 귀테리어가 완성됩니다.", tip: "안쪽에 위치해 있어 비교적 머리카락이나 옷에 덜 걸리는 장점이 있어 관리가 비교적 수월한 편입니다." },
    en: { name: "Inner Conch", name_en: "Inner Conch", healing: "2 ~ 3 months", pain: 3, desc: "Located in the center cup of the ear. It stands out beautifully with high dimensional sparkle from the front. Swapping to a large hoop or bold ring after healing creates a gorgeous look.", tip: "Since it is tucked inside the ear, it catches less on hair and clothes, making it relatively easier to heal and maintain." },
    ja: { name: "インナーコンク", name_en: "Inner Conch", healing: "2 〜 3ヶ月", pain: 3, desc: "耳の中央のくぼんだ軟骨部分で、正面から見たときに立体的にキラキラと輝くため、非常に人気があります。完成後に大きなリングやボリュームのあるジュエルに交換すると、より華やかになります。", tip: "耳の内側奥に位置しているため、髪や服に引っかかりにくく、比較的ケアしやすいメリットがあります。" },
    ru: { name: "Конч", name_en: "Inner Conch", healing: "2 ~ 3 месяца", pain: 3, desc: "Прокол в центральной чаше ушной раковины. Смотрится очень эффектно и объемно при взгляде спереди. Замена на широкое кольцо после заживления делает образ невероятно роскошным.", tip: "Поскольку прокол расположен внутри ушной раковины, он меньше подвержен трению об одежду и волосы, что облегчает заживление." },
    ar: { name: "غضروف الأذن الداخلي", name_en: "Inner Conch", healing: "2 ~ 3 أشهر", pain: 3, desc: "يقع في التجويف الأوسط للأذن. يبرز بشكل جميل ومجسم من الأمام. استبدال القطعة بحلقة كبيرة أو قطعة بارزة بعد الشفاء يمنحك مظهراً رائعاً للغاية.", tip: "بما أنه يقع في تجويف الأذن الداخلي، فهو أقل عرضة للاحتكاك بالشعر أو الملابس، مما يجعل العناية به أسهل." },
    zh: { name: "内耳廓", name_en: "Inner Conch", healing: "2 ~ 3个月", pain: 3, desc: "位于耳朵中部的内凹软骨盆地。正面佩戴具有强烈的立体闪耀感，备受欢迎。消肿恢复后可更换为环形圈或大闪钻，打造高级华丽风格。", tip: "由于深处耳朵内侧陷落处，被头发或衣服意外挂碰的几率较低，日常打理和恢复相对轻松。" }
  },
  tragus: {
  ...
  outconch: {
    ko: { name: "아웃컨츠 / 플랫", name_en: "Outer Conch / Flat", healing: "2 ~ 3개월", pain: 3, desc: "귀 위쪽 넓고 평평한 연골 부위(플랫)로, 화려하고 큰 팬던트나 멀티 스톤 주얼리를 세팅하기 가장 좋은 캔버스 같은 공간입니다. 넓은 면적 덕분에 다채로운 디자인 연출이 가능합니다.", tip: "안경 다리나 마스크 끈에 닿아 자극을 받기 쉬우므로 쓸리지 않도록 섬세한 주의가 요구됩니다." },
    en: { name: "Outer Conch / Flat", name_en: "Outer Conch / Flat", healing: "2 ~ 3 months", pain: 3, desc: "The flat cartilage space in the upper ear. Like a canvas, it's the perfect spot for showcase jewelry, large pendants, or clustered studs. Offers maximum styling versatility.", tip: "It is highly susceptible to rubbing against glasses arms, hairpins, or face mask loops. Pay close attention to keep it friction-free." },
    ja: { name: "アウターコンク", name_en: "Outer Conch / Flat", healing: "2 〜 3ヶ月", pain: 3, desc: "耳の上部にある平らな軟骨部分（フラット）で、華やかで大ぶりなチャームやマルチストーンを飾るのに最適なキャンバスのようなスペースです。広い面積のおかげで、個性的な表現が可能です。", tip: "メガネのつるやマスクの紐が当たりやすく刺激を受けやすいため、擦れないように細心の注意を払う必要があります。" },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateEarInfo(placementKey) {
    ...
    earEn.textContent = data.name_en || (placementKey.charAt(0).toUpperCase() + placementKey.slice(1));
